...
contract Exchange is ERC20, ReentrancyGuard {
     ...
     */
     //this is the buggy function: the rate is comupted based on internal k algo
    ...
    function removeLiquidity(
        ...
        //buggy: here the reserve is computed based on balance of two tokens (baseToken and quoteToken) in the current pool
