...
contract RewardsHypervisor {
    ...
    function deposit(
        ...
        //call the owner function of the attack contract. 
        //As long as the attack contract sets the return value to the contract address
        // call the delegatedTransferERC20 function of the attack contract. 
        //Here reentrancy is executed
        if(isContract(from)) {
          require(IVisor(from).owner() == msg.sender); 
          //deposit func is called again 
